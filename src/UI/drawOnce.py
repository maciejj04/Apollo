...
def drawOnce(wave, chart):
    ...
    (nchannels, sampwidth, framerate, nframes, comptype, compname) = Cai.getInformations()
    ...
    i=0
    for startFrame in my_range(0, Cai.numberOfFrames, chunk):
